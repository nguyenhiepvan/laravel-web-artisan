...
<div id="webartisan__window" @if($webartisan->isAuthenticated()) class="webartisan__window__authenticated" @endif>
    ...
    @if(config('webartisan.use_authentication'))
        ...
        <span class="webartisan__window__command_auth webartisan__window__for_auth"
              id="webartisan__window__command_username">
        ...
        <span class="webartisan__window__command_auth webartisan__window__for_auth"
              id="webartisan__window__command_password" style="display:none;">
